...
async def OwnerStart(event):
    ...
    if sender.id == ramy_id :
        order = await event.reply('اهلا مطوري [- L7N  <\>](tg://user?id=5528416973) ✓')
...
async def _(event):
        ...
        await sython.send_message('@zmmbot', 'جاري التجميع بواسطة | L7N TEAM')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
      await event.reply("""السـورس يعمـل | L7N
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
مطور السورس : https://t.me/g_4_q
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""L7N OWNER : @g_4_q """
)
